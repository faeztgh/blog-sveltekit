		...
		<div class="m-auto ">
			<div class="rounded-xl bg-white shadow-xl">
				<div class="p-6 sm:p-16">
					<div class="space-y-4">
						<img class="h-16 w-16" src={logo} alt="logo" loading="lazy"/>

						<h2 class="mb-8 text-2xl text-cyan-900 font-bold">
							Sign in to use our incredible features!
						</h2>
					</div>
					<div class="mt-16 grid space-y-4">
						...
						>
							<div class="relative flex items-center space-x-4 justify-center">
								<span class="absolute left-0 w-5">
					...
					<div class="mt-32 text-gray-600 sm:-mb-8">
						<p class="text-xs">
						...
						<p class="text-xs mt-4">
							...
							>
							and <a href="#" class="underline">Terms of Service</a> apply.
						</p>
					</div>
				</div>
			</div>
