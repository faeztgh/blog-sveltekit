...
<section 
transition:fade
class="bg-white dark:bg-primary py-20 lg:py-[120px] overflow-hidden relative z-10">
	<div class="container">
		<div class="flex flex-wrap lg:justify-between -mx-4">
			<div class="w-full lg:w-1/2 xl:w-6/12 px-4">
				<div class="max-w-[570px] mb-12 lg:mb-0 text-primary dark:text-gray-200">
					<span class="block mb-4 text-base  font-semibold"> Contact Us </span>
					<h2
						class="
                   text-dark
                   mb-6
                   ...
                   "
					...
					<p class="text-base text-body-color leading-relaxed mb-9">
						If you have any question or problem with our services, please feel free to contact us.
					</p>
					<div class="flex mb-8 max-w-[370px] w-full">
                      ...
                      "
						...
						<div class="w-full">
							...
							<p class="text-base text-body-color">99 S.t Street, New York, NY 10001</p>
						</div>
					</div>
					<div class="flex mb-8 max-w-[370px] w-full">
						<div
                      ...
                      "
						...
						<div class="w-full">
							...
							<p class="text-base text-body-color">(+1) 561 5656 65</p>
						</div>
					</div>
					<div class="flex mb-8 max-w-[370px] w-full">
						<div
                      ...
                      "
						...
						<div class="w-full">
							...
							<p class="text-base text-body-color">info@faeztgh.com</p>
						</div>
					</div>
				</div>
			</div>
